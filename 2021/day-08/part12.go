...
func part2(displays []Display) {
	...
	for _, display := range displays {
		...
		for _, signals := range display.Inputs {
			...
			or4 := (signalsFor[4] | signals).Len()

			if Len == 6 && and7 == 3 && or7 == 6 && and4 == 3 && or4 == 7 {
				signalsFor[0] = signals
			} else if Len == 5 && and7 == 2 && or7 == 6 && and4 == 2 && or4 == 7 {
				signalsFor[2] = signals
			} else if Len == 5 && and7 == 3 && or7 == 5 {
				signalsFor[3] = signals
			} else if Len == 5 && and7 == 2 && or7 == 6 && and4 == 3 && or4 == 6 {
				signalsFor[5] = signals
			} else if Len == 6 && and7 == 2 && or7 == 7 {
				signalsFor[6] = signals
			} else if Len == 6 && and7 == 3 && or7 == 6 && and4 == 4 && or4 == 6 {
